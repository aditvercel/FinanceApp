  ...
  const renderContent = () => {
    ...
    return (
      <div className="space-y-4">
        <div>
          <label htmlFor="report-select" className="block text-sm font-medium text-(--foreground) mb-1.5">
            Select Report
          </label>
          <select
            id="report-select"
            ...
            className="w-full py-2.5 px-3 border border-(--border) rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-(--card) text-(--foreground) transition-all"
          >
